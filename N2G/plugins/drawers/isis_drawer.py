...
If no TTP modules installed, on an attempt to instantiate ``isis_drawer``
...
.. autofunction:: N2G.plugins.drawers.isis_drawer.isis_drawer
.. autofunction:: N2G.plugins.drawers.isis_drawer.isis_drawer.work
"""
import logging
import json
import os
        ...
        if isinstance(data, dict):
            for platform_name, text_list in data.items():
                ttp_template = get_template(
                    misc="N2G/isis_lsdb/{}.txt".format(platform_name)
                )
